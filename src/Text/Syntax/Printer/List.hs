...
import Text.Syntax.Poly.Type (RunPrinterT)
...
runPolyPrinter :: Eq tok => RunPrinterT tok [tok] a String
runPolyPrinter printer = maybe (Left "print error") Right . runPrinter printer
